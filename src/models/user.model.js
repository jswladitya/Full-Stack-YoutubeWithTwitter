...
//jo bhi data save ho rah he usse pehle password encrypt karana he
userSchema.pre("save", async function (next) {
    if(!this.isModified("password")) return next(); //ager password modify hua hi nahi he toh age mat badho
